...
const TemplateThree = ({ resumeData, colorPalette, containerWidth }) => {
    ...
    return (
        ...
        >
                ...
                >
                    {resumeData.profileInfo.profilePreviewUrl ? (
                        <img
                            ...
                            alt="profile"
                            className="w-[90px] h-[90px] rounded-2xl object-cover border-2 border-white shadow"
                        />
                    ) : (
                        <div
                            className="w-[90px] h-[90px] flex items-center justify-center text-5xl rounded-2xl"
            ...
            <div className="grid grid-cols-12 gap-0 text-[17px]">
                {/* Left - Square block */}
                <div className="col-span-4 h-full flex flex-col items-center pt-5" style={{ backgroundColor: themeColors[0] }}>

                    <div className="my- mx-6">
                ...
                <div className="col-span-8 pt-10 mr-0 pl-10">
                    <div>
